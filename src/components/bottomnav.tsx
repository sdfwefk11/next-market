...
export default function BottomNav() {
  ...
  return (
    <nav className="bg-white text-gray-800 border-t fixed bottom-0 py-3 px-10 flex justify-between items-center max-w-xl w-full select-none">
      ...
      <Link scroll={false} href="/community">
        <div
          className={cls(
            "flex flex-col items-center",
        ...
        >
          ...
          <span className="text-xs font-bold mt-1 text-gray-800">동네생활</span>
        </div>
      </Link>
      <Link scroll={false} href="chats">
        <div
          className={cls(
            "flex flex-col items-center",
        ...
        >
          ...
          <span className="text-xs font-bold mt-1 text-gray-800">채팅</span>
        </div>
      </Link>
      <Link scroll={false} href="/stream">
        <div
          className={cls(
            "flex flex-col items-center",
        ...
        >
          ...
          <span className="text-xs font-bold mt-1 text-gray-800">라이브</span>
        </div>
      </Link>
