      ...
      <body className="w-full max-w-xl mx-auto pt-[80px] pb-[70px]">
        ...
        {hasTabBar ? (
          <nav className="bg-white text-gray-800 border-t fixed bottom-0 py-3 px-10 flex justify-between items-center max-w-xl w-full select-none">
            <Link href="/">
              <BottomTabBar title="홈" path={path}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <Link href="/community">
              <BottomTabBar title="동네생활" path={path}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <Link href="chats">
              <BottomTabBar title="채팅" path={path}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <Link href="/stream">
              <BottomTabBar title="라이브" path={path}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <Link href="/profile">
              <BottomTabBar title="마이페이지" path={path}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
